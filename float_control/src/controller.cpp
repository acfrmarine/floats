...
#include "float_control/SetThrusterCommand.h"
#include "float_control/SetDepthTarget.h"
#include "float_control/SetAltitudeTarget.h"
...
class Controller
{
    public:
        Controller()
        {
            ...
            // Set the last depth + altitude times to 0 linux time
            last_depth_time_ = ros::Time(0.0);
            last_altitude_time_ = ros::Time(0.0);
